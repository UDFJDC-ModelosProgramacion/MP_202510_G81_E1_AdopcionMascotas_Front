...
import { Pet, Shelter } from "../src/types";
...
export default function HomePage() {
    ...
    const loadData = async () => {
        try {
            ...
            console.log('Shelters data received:', sheltersData);
    ...
    const filteredPets = pets.filter((pet) => {
        ...
        return (
            ...
            (!filters.breed ||
                (pet.breed && pet.breed.toLowerCase().includes(filters.breed.toLowerCase())))
        );
    });
        ...
        <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50">
            ...
            <section className="py-20 px-4 relative overflow-hidden">
                ...
                <div className="container mx-auto text-center relative z-10">
                    ...
                    <h2 className="text-5xl md:text-6xl font-bold text-orange-800 mb-6">
                        Encuentra tu compañero perfecto
                    </h2>
                    <p className="text-xl text-orange-700 mb-8 max-w-2xl mx-auto leading-relaxed">
                        Miles de mascotas esperan encontrar un hogar lleno de
                        amor. Únete a nuestra comunidad y cambia una vida para
                        siempre.
                    </p>
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {filteredPets.map((pet) => (
                                        <div
                                            key={pet.id}
                                            className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden group"
                                        >
                                            ...
                                            <div className="p-6">
                                                ...
                                                <div className="space-y-2 mb-4">
                                                    ...
                                                    <div className="flex items-center text-sm text-orange-700">
                                                        <MapPin className="h-4 w-4 mr-2" />
                                                        {pet.shelter?.name || 'Sin refugio asignado'}
                                                    </div>
                                                </div>
                                                <p className="text-sm text-orange-600 mb-4 line-clamp-3">
                                                    {pet.behaviorProfile || 'Sin descripción disponible'}
                                                </p>
                                                <Link
                                                    to={pet.shelter?.id ? `/shelter/${pet.shelter.id}/pet/${pet.id}` : '#'}
                        ...
                        {activeTab === "shelters" && (
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                {shelters.map((shelter) => (
                                    <div
                                        key={shelter.id}
                                        className="bg-white/80 backdrop-blur-sm rounded-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 overflow-hidden"
                                    >
            ...
            <section className="py-20 bg-gradient-to-r from-orange-600 via-amber-600 to-orange-700 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <p className="text-xl mb-8 max-w-2xl mx-auto opacity-90 leading-relaxed">
                        Únete a nuestra comunidad de adoptantes y brinda amor a
                        una mascota que lo necesita. El proceso es simple y te
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <p className="text-orange-200">
                                Conectando mascotas con familias amorosas desde
                                2020.
                            </p>
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <p className="text-orange-200">
                                Mantente actualizado con nuestras últimas
                                adopciones y eventos.
                            </p>
                        </div>
                    </div>
