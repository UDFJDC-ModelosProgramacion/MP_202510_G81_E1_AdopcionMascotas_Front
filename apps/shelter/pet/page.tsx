    ...
    useEffect(() => {
        const loadPetData = async () => {
            ...
            try {
                setLoading(true);
                setError(null);
                const petData = await api.getPetDetailWithFallback(
                    shelterId,
                    petId
                );
                            ...
                            <Card className="border-orange-200 shadow-lg">
                                <CardHeader className="bg-gradient-to-r from-orange-50 to-amber-50">
                                    ...
                                    <CardDescription className="text-orange-600 text-lg">
                                        {pet.breed} • {getSizeLabel(pet.size)} •{" "}
                    ...
                    >
                                        ...
                                        {pet.vaccineCard && (
                                            <div className="bg-green-50 p-3 rounded-lg">
                                                ...
                                                <p className="text-sm text-green-600">
                                                    Última vacuna:{" "}
                                                    {pet.vaccineCard.lastVaccineDate.toLocaleDateString()}
                                                </p>
                                                <p className="text-sm text-green-600">
                                                    Veterinario:{" "}
                                                    {
                                        ...
                                        {pet.vaccineCard && (
                                            <div className="bg-blue-50 p-3 rounded-lg">
                                                ...
                                                <p className="text-sm text-blue-600">
                                                    ...
                                                    {pet.vaccineCard.lastDewormingDate.toLocaleDateString()}
                                                </p>
                                            </div>
                                        )}
                                    </CardContent>
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600">
                                                        {pet.shelterArrival.arrivalDate.toLocaleDateString()}
                                                    </p>
                                                </div>
                                                <div>
                                                    <span className="text-sm font-medium">
                        ...
                        <TabsContent value="vaccines" className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-orange-700">
                                    Historial completo de vacunas y
                                    desparasitaciones de {pet.name}
                                </p>
                            </div>
                            ...
                            {pet.vaccineCard ? (
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    ...
                                    <Card className="border-green-200">
                                        ...
                                        <CardContent className="p-6 space-y-4">
                                            {pet.vaccineCard.vaccines.map(
                                                (vaccine) => (
                                                    <div
                                                        key={vaccine.id}
                                                        className="border border-green-200 p-4 rounded-lg"
                                                    >
                                                        ...
                                                        <div className="space-y-1 text-sm text-green-700">
                                                            ...
                                                            <p>
                                                                ...
                                                                {vaccine.nextDate.toLocaleDateString()}
                                                            </p>
                                                            <p>
                                                                <strong>
                                                                    Dosis:
                                    ...
                                    <Card className="border-purple-200">
                                        ...
                                        <CardContent className="p-6 space-y-4">
                                            {pet.vaccineCard.dewormings.map(
                                                (deworming) => (
                                                    <div
                                                        key={deworming.id}
                                                        className="border border-purple-200 p-4 rounded-lg"
                                                    >
                                                        <div className="flex justify-between items-start mb-2">
                                                        ...
                                                        <div className="space-y-1 text-sm text-purple-700">
                                                            <p>
                                                                ...
                                                                {deworming.date.toLocaleDateString()}
                                                            </p>
                                                            <p>
                                                                <strong>
                                                                    Próxima:
                                                                </strong>{" "}
                                                                {deworming.nextDate.toLocaleDateString()}
                                                            </p>
                                                            <p>
                                                                <strong>
                                                                    Veterinario:
                        ...
                        <TabsContent value="medical" className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-orange-700">
                                    Registro completo de eventos médicos y
                                    tratamientos
                                </p>
                            </div>
                                            ...
                                            {event.nextAppointment && (
                                                <div className="mt-4 p-3 bg-blue-50 rounded-lg">
                                                    <p className="text-sm text-blue-800">
                                                        ...
                                                        {event.nextAppointment.toLocaleDateString()}
                                                    </p>
                                                </div>
                                            )}
                                        </CardContent>
                        ...
                        <TabsContent value="applications" className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-orange-700">
                                    Personas interesadas en adoptar a {pet.name}
                                </p>
                            </div>
                            ...
                            <div className="space-y-4">
                                {pet.adoptionApplications.map((application) => (
                                    <Card
                                        key={application.id}
                                        className="border-orange-200 hover:shadow-lg transition-all duration-300"
                                    >
                                        <CardContent className="p-6">
                                            <div className="flex items-start justify-between mb-4">
                                                <div>
                                                ...
                                                <div>
                                                    ...
                                                    {application.homeVisitDate && (
                                                        <p className="text-sm">
                                                            ...
                                                            {application.homeVisitDate.toLocaleDateString()}
                                                        </p>
                                                    )}
                                                </div>
                                            </div>
                            ...
                            {pet.adoptionApplications.length === 0 && (
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-gray-500">
                                        No hay solicitudes de adopción aún.
                                    </p>
                                </div>
                            )}
                        </TabsContent>
                        ...
                        <TabsContent value="adoptions" className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-orange-700">
                                    Registro completo de adopciones de{" "}
                                    {pet.name}
                                </p>
                            </div>
                                    ...
                                    <CardContent>
                                        <div className="space-y-2">
                                            <p>
                                                ...
                                                {pet.adoption.owner.name}
                                            </p>
                                            <p>
                                                <strong>Fecha:</strong>{" "}
                                                {pet.adoption.adoptionDate.toLocaleDateString()}
                                            </p>
                                            <p>
                                                <strong>Estado:</strong>{" "}
                                                {pet.adoption.adoptionStatus}
                                            </p>
                                        </div>
                                    </CardContent>
                                </Card>
                        ...
                        <TabsContent value="media" className="space-y-6">
                            <div className="text-center mb-6">
                                ...
                                <p className="text-orange-700">
                                    Fotos y videos de nuestra querida mascota
                                </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                {pet.multimedia.map((media) => (
                                    <Card
                                        key={media.id}
                                        className="border-orange-200 overflow-hidden"
                                    >
                                        ...
                                        <CardContent className="p-4">
                                            ...
                                            <p className="text-sm text-gray-600">
                                                {media.uploadDate.toLocaleDateString()}
                                            </p>
                                        </CardContent>
                                    </Card>
                                ))}
            ...
            <section className="py-16 bg-gradient-to-r from-orange-600 via-amber-600 to-orange-700 text-white relative overflow-hidden">
                ...
                <div className="container mx-auto px-4 text-center relative z-10">
                    ...
                    <h3 className="text-3xl font-bold mb-6">
                        ¿Te enamoraste de {pet.name}?
                    </h3>
                    <p className="text-lg mb-8 max-w-2xl mx-auto opacity-90 leading-relaxed">
                        {pet.name} está esperando por ti. Inicia el proceso de
                        adopción y dale el hogar que se merece.
                    </p>
            ...
            <footer className="bg-orange-900 text-white py-12">
                <div className="container mx-auto px-4">
                    ...
                    <div className="border-t border-orange-800 mt-8 pt-8 text-center text-orange-200">
                        <p>
                            &copy; 2024 Aves de Hermes. Todos los derechos
                            reservados.
                        </p>
                    </div>
                </div>
