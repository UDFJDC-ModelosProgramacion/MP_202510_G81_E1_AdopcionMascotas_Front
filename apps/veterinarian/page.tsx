...
export default function VeterinarianDetailPage() {
    ...
    const getStats = (vet: VeterinarianDetailDTO) => {
        return {
            ...
            totalAdoptions: vet.adoptionApplications.filter(
            ...
            successRate:
                vet.adoptionTests.length > 0
                    ? Math.round(
                          (vet.adoptionTests.filter(
                              (test) => test.result === "PASSED"
                          ).length /
                              vet.adoptionTests.length) *
                              100
                      )
                    : 100,
            averageScore:
            ...
            <div className="min-h-screen bg-gradient-to-br from-orange-50 to-amber-50 flex items-center justify-center">
                <div className="text-center">
                    ...
                    <p className="mt-4 text-gray-600">
                        Cargando información del veterinario...
                    </p>
                </div>
            </div>
        );
                            ...
                            <Card className="border-orange-200 shadow-xl sticky top-24">
                                <CardHeader className="text-center bg-gradient-to-r from-blue-50 to-indigo-50">
                                    ...
                                    <CardDescription className="text-blue-600 text-lg">
                                        {specialityLabels[
                                            vet.speciality as keyof typeof specialityLabels
                                        ] || vet.speciality}
                                    </CardDescription>
                            ...
                            >
                                ...
                                >
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-blue-700">
                                            Historial completo de consultas y
                                ...
                                >
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-blue-700">
                                            Evaluaciones y recomendaciones para
                                            procesos de adopción
                                        </p>
                                    </div>

                                    <div className="space-y-4">
                                        {vet.adoptionApplications.map(
                                            (application) => (
                                                <Card
                                                    key={application.id}
                                                    className="border-blue-200 hover:shadow-lg transition-all duration-300"
                                        ...
                                        {vet.adoptionApplications.length ===
                                            0 && (
                                            <div className="text-center py-8">
                                                <FileText className="mx-auto h-12 w-12 text-gray-400 mb-4" />
                                                <p className="text-gray-500">
                                                    No hay solicitudes de
                                                    adopción registradas.
                                                </p>
                                            </div>
                                        )}
                                    </div>
                                ...
                                >
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-blue-700">
                                            Monitoreo del bienestar de mascotas
                                            adoptadas
                                        </p>
                                    </div>
                                                ...
                                                <CardContent className="p-6">
                                                    <div className="flex items-start justify-between mb-4">
                                                        <div>
                                                            ...
                                                            <p className="text-gray-600">
                                                                Adopción:{" "}
                                                                {followUp.adoptionDate.toLocaleDateString()}{" "}
                                                                (
                                                                {
                                                                    followUp.monthsPostAdoption
                                                                }{" "}
                                                                meses)
                                                            </p>
                                                        </div>
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                                                        <div className="flex items-center text-sm text-gray-600">
                                                            ...
                                                            <span>
                                                                Seguimiento:{" "}
                                                                {followUp.followUpDate.toLocaleDateString()}
                                                            </span>
                                                        </div>
                                                        <div className="flex items-center text-sm text-gray-600">
                                ...
                                >
                                    <div className="text-center mb-6">
                                        ...
                                        <p className="text-blue-700">
                                            Evaluaciones de compatibilidad y
                                            comportamiento
                                        </p>
                                    </div>
