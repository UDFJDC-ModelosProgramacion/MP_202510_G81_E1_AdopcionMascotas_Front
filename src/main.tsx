  ...
  <StrictMode>
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/shelter/:shelterId/pet/:petId" element={<PetDetailPage />} />
        <Route path="/shelter/:shelterId/pet/:petId/adopt" element={<AdoptionApplicationPage />} />
        <Route path="/veterinarian/:id" element={<VeterinarianDetailPage />} />
        <Route path="/adoption/dashboard" element={<AdoptionDashboard />} />
